...
resource "null_resource" "cluster" {
  ...
  provisioner "file" {
    content = templatefile("${path.module}/inventory.tpl", {
      ...
      fluent_binaries          = var.fluent_binaries,
      fluent_version           = var.fluent_version,
      fluent_license_server_ip = var.fluent_license_server_ip,
      fluent_license_port      = var.fluent_license_port,
      fluent_flexnet_port      = var.fluent_flexnet_port,
