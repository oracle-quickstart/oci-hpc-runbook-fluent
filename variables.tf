...
variable "fluent" { default = true }
variable "fluent_binaries" {}
variable "fluent_version" { default = "202" }
variable "fluent_license_port" { default = "2325" }
variable "fluent_flexnet_port" { default = "1055" }
variable "fluent_license_server_ip" {}
